...
**Knowledge is player-generated**  
Instead of an automated tracking system, the player maintains their own map of the building through freeform annotations  
Every note reflects the player's interpretation of incomplete information, making memory, observation, and deduction as important as the surveillance system itself
